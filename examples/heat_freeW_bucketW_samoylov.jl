...
strat = @Stratigraphy(
    ...
    0.0u"m" => :topsoil1 => HomogeneousSoil(MineralOrganic(por=0.80,sat=0.7,org=0.75), heat=HeatBalance(), water=WaterBalance(BucketScheme())),
    0.1u"m" => :topsoil2 => HomogeneousSoil(MineralOrganic(por=0.80,sat=0.8,org=0.25), heat=HeatBalance(), water=WaterBalance(BucketScheme())),
    0.4u"m" => :sediment1 => HomogeneousSoil(MineralOrganic(por=0.55,sat=0.9,org=0.25), heat=HeatBalance(), water=WaterBalance(BucketScheme())),
    3.0u"m" => :sediment2 => HomogeneousSoil(MineralOrganic(por=0.50,sat=1.0,org=0.0), heat=HeatBalance(), water=WaterBalance(BucketScheme())),
    10.0u"m" => :sediment3 => HomogeneousSoil(MineralOrganic(por=0.30,sat=1.0,org=0.0), heat=HeatBalance(), water=WaterBalance(BucketScheme())),
