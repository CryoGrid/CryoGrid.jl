...
# Snow mass balance
CryoGrid.variables(snow::BulkSnowpack, smb::SnowMassBalance{<:Dynamic}) = (
    Prognostic(:swe, Scalar, u"m"),
    Diagnostic(:ρsn, Scalar, u"kg/m^3"),    
    snowvariables(snow, smb)...,
)
CryoGrid.variables(snow::BulkSnowpack, smb::SnowMassBalance{<:Prescribed}) = (
...
function CryoGrid.prognosticstep!(
    snow::BulkSnowpack,
    procs::Coupled{SnowMassBalance{<:Dynamic{LinearAccumulation,InstantaneousRunoff}},<:Heat{FreeWater,Enthalpy}},
    ssnow,
)
