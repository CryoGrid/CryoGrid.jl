"""
    LinearTwoPhaseTempProfile{TT1,TT2,TTb,TTm,Tz1,Tz2,Tz3} <: VarInitializer{:T}
...
and `z_base` is the permafrost base freezing front depth which is assumed
to have temperature equal to `Tmelt`.
"""
Base.@kwdef struct LinearTwoPhaseTempProfile{TT1,TT2,TTb,TTm,Tz1,Tz2,Tz3} <: VarInitializer{:T}
    T0::TT1 = 1.0u"°C"
    T1::TT2 = -10.0u"°C"
    Tm::TTm = 0.0u"°C"
    Tbot::TTb = 10.0u"°C"
